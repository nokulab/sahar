...
- configuration-driven contact details and browser-only email drafts
...
5. Open **Settings → Secrets and variables → Actions → Variables** and add `PUBLIC_SITE_URL`, `PUBLIC_BASE_PATH` and `PUBLIC_CONTACT_EMAIL`.
...
- verify production hosting, email, processor and security information;
